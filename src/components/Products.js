  ...
  const handleInputChange = (event) => {
    ...
    setStateObject({
      ...
      filteredData: initialData
        ...
        .sort((a, b) =>
          parsed.sort === "descending"
            ? a.price > b.price
              ? 1
              : -1
            : parsed.sort === "ascending"
            ? a.price < b.price
              ? 1
              : -1
            : null
    ...
    >
      <ul className="responsive-table">
        <div className="table-sorting">
          <button name="reset" onClick={handle}>
            Reset
          </button>
          <button name="ascending" onClick={handle}>
            Sort up
          </button>
          <button name="descending" onClick={handle}>
            Sort down
          </button>
        </div>
        ...
        {stateObject.filteredData.map(
          ({ name, shortDescription, price, id, slug }) => {
